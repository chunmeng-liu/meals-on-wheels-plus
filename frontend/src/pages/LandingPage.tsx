  ...
  return (
    <main className="landing">
      <section className="hero">
        ...
        <p>One simple place for seniors to request meal deliveries, human companion visits, and in-home RoboCompanion Visits.</p>
      ...
      <section className="feature-grid" aria-label="Services">
        ...
        <article className="feature"><span>03</span><h2>RoboCompanion Visits</h2><p>Request an in-home visit with a scheduled physical assistive robot managed by our team.</p></article>
      </section>
    </main>
  );
}
